...
public class CurrentUserProfilePage {
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().className(\"androidx.recyclerview.widget.RecyclerView\").childSelector(new UiSelector().className(\"android.view.ViewGroup\"))")
	...
	public boolean isActive() throws Exception {
		return driver.isElementDisplayed(editProfile);
	}
	...
	public String getSavedCount() throws Exception {
		return driver.getText(saved);
	}
	...
	public HomeSearchPage clickSearch() throws Exception {
		driver.click(searchProfile);
